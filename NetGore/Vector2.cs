...
namespace NetGore
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        // SFML 2.6 compatibility conversions
        public static implicit operator SFML.System.Vector2f(Vector2 v)
        {
            return new SFML.System.Vector2f(v.X, v.Y);
        }

        public static implicit operator Vector2(SFML.System.Vector2f v)
        {
            return new Vector2(v.X, v.Y);
        }

        public static implicit operator SFML.System.Vector2i(Vector2 v)
        {
            return new SFML.System.Vector2i((int)v.X, (int)v.Y);
        }

        public static implicit operator Vector2(SFML.System.Vector2i v)
        {
            return new Vector2(v.X, v.Y);
        }

        public static implicit operator SFML.System.Vector2u(Vector2 v)
        {
            return new SFML.System.Vector2u((uint)v.X, (uint)v.Y);
        }

        public static implicit operator Vector2(SFML.System.Vector2u v)
        {
            return new Vector2(v.X, v.Y);
        }
