...
namespace NetGore
{
    ...
    {
        public static BlendMode ReadBlendMode(this IValueReader reader, string name)
        {
            // SFML 2.6: BlendMode is a class, not an enum, so we read as string and map to static fields
