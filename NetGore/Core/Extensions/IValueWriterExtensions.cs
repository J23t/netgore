...
namespace NetGore
{
    ...
    public static class IValueWriterExtensions
    {
        ...
        {
            // SFML 2.6: BlendMode is a class, not an enum, so we write the name as a string
            string blendModeName = "Alpha"; // default
            if (value == BlendMode.Add) blendModeName = "Add";
            else if (value == BlendMode.Alpha) blendModeName = "Alpha";
            else if (value == BlendMode.Multiply) blendModeName = "Multiply";
            else if (value == BlendMode.Min) blendModeName = "Min";
            else if (value == BlendMode.Max) blendModeName = "Max";
            else if (value == BlendMode.None) blendModeName = "None";
            
            writer.Write(name, blendModeName);
        }
