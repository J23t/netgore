...
namespace NetGore.Graphics
{
    ...
    public static class FontExtensions
    {
        ...
        /// <summary>
        /// Gets the default size for a font. Returns the DefaultSize property for LazyFont, or 12 otherwise.
        /// </summary>
        public static uint DefaultSize(this Font font)
        {
            if (font is LazyFont lazyFont)
                return lazyFont.DefaultSize;
            return 12;
        }
        ...
        /// <param name="font">The <see cref="Font"/>.</param>
        /// <param name="str">The string to measure.</param>
        /// <param name="fontSize">The size of the font. If equal to 0, a default size will be used.</param>
        /// <returns>The size of the <paramref name="str"/>.</returns>
        ...
        /// <summary>
        /// Gets the line spacing for the font using its default size.
        /// </summary>
        /// <param name="font">The <see cref="Font"/>.</param>
        /// <returns>Line spacing in pixels.</returns>
        public static int GetLineSpacing(this Font font)
        {
            return (int)font.GetLineSpacing(font.DefaultSize());
        }
    }
}