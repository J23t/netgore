...
namespace NetGore.Graphics.GUI
{
    ...
    public class EditableTextHandler
    {
        ...
        static EditableTextHandler()
        {
            ...
            try
            {
                // Registry.CurrentUser may be null on non-Windows platforms
                if (Registry.CurrentUser != null)
                {
                    ...
                    if (regSubKey != null)
                    {
                        ...
                        if (desktopKey != null)
                        {
                            var blinkRateObj = desktopKey.GetValue("CursorBlinkRate");
            ...
            {
                // Registry not supported on this platform (e.g. Linux)
                blinkRate = _defaultCursorBlinkRate;
            }
