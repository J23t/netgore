...
namespace NetGore.Content
{
    ...
    public class ContentManager : IContentManager
    {
        ...
        sealed class MyLazyFont : LazyFont, IMyLazyAsset
        {
            ...
            /// </summary>
            /// <param name="filename">Font file to load</param><param name="charSize">Character size</param>
        ...
        sealed class MyLazyImage : LazyTexture, IMyLazyAsset
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="T:SFML.Graphics.LazyTexture"/> class.
            /// </summary>
